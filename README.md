...
Authored by Joseph R. Laforet Jr.  
Builds configurable all-atom PE/PEAA ionomer systems with explicit hydrogen caps and sodium counterions, exports role-aware SDF files, and provides an OpenFF/OpenMM handoff path
